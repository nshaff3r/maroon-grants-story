...
const Headline = () => {
  return (
    <div className="headerdiv">
      <h1 id="header"> $25.5 Million in Terminated Federal Research Grants at UChicago, Visualized </h1>
      <h2 id="subhead">The Maroon used publicly available data to track millions of dollars in research grants that were terminated at UChicago last spring, as the Trump administration cut funding for universities nationwide.</h2>
    </div>
  )
}
